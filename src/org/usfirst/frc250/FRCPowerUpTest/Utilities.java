...
import static org.usfirst.frc250.FRCPowerUpTest.RobotMap.kDEADBAND_WIDTH;
...
public class Utilities {
	...
	// encoder pulses to distance traveled in feet
	public static double encoderDistanceToFeet(int encoderDistance) {
		return encoderDistance / Robot.prefs2.getDouble("Drive Gear Box Encoder PPR") / Robot.prefs2.getDouble("Drive Gear Box Encoder Ratio")
				/ Robot.prefs2.getDouble("Drive Gear Box 3rd Stage Ratio") * Robot.prefs2.getDouble("Drive Wheel Circumferece");
	}

	// distance traveled in feet to encoder pulses
	public static int distanceInFeetToEncoderPulses(double feet) {
		return (int) Math.round(feet * Robot.prefs2.getDouble("Drive Gear Box Encoder PPR") * Robot.prefs2.getDouble("Drive Gear Box Encoder Ratio")
				* Robot.prefs2.getDouble("Drive Gear Box 3rd Stage Ratio") / Robot.prefs2.getDouble("Drive Wheel Circumference"));
	}
}